...
2. Chọn **File -> Open** và trỏ tới kịch bản: `backend/jmeter/TravelAPI_LoadTest.jmx` (nằm trong thư mục dự án).
...
```bash
# Di chuyển vào thư mục chứa kịch bản từ thư mục gốc của dự án
cd backend/jmeter
