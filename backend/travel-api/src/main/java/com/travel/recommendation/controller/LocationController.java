...
public class LocationController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<LocationResponse>> createLocation(@RequestBody LocationRequest locationRequest) {
        return ResponseEntity.ok(ApiResponse.success(locationService.saveLocation(locationRequest)));
    }

    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<LocationResponse>> updateLocation(@PathVariable Long id, @RequestBody LocationRequest locationRequest) {
