        ...
        <div className="space-y-8">
            <div className="flex justify-between items-center">
                ...
                <button 
                    ...
                    className="flex items-center gap-2 px-6 py-3 bg-orange-600 text-white rounded-2xl font-bold shadow-lg shadow-orange-200 dark:shadow-none transition-all"
                >
            ...
            {showForm && (
                <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xl">
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-xl font-bold text-slate-900 dark:text-white">{editingBlog ? 'Chỉnh sửa bài viết' : 'Tạo bài viết mới'}</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <input 
                                    className="w-full px-5 py-3 bg-slate-50 dark:bg-slate-800 border-none rounded-2xl focus:ring-2 focus:ring-orange-500 transition-all"
                            ...
                            <div className="space-y-2">
                                ...
                                <select 
                                    className="w-full px-5 py-3 bg-slate-50 dark:bg-slate-800 border-none rounded-2xl focus:ring-2 focus:ring-orange-500 transition-all appearance-none"
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea 
                                className="w-full px-5 py-3 bg-slate-50 dark:bg-slate-800 border-none rounded-2xl focus:ring-2 focus:ring-orange-500 transition-all h-20"
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea 
                                className="w-full px-5 py-3 bg-slate-50 dark:bg-slate-800 border-none rounded-2xl focus:ring-2 focus:ring-orange-500 transition-all h-60"
                        ...
                        <div className="flex justify-end gap-3">
                            ...
                            <button type="submit" className="px-10 py-3 bg-orange-600 text-white rounded-2xl font-black shadow-lg shadow-orange-100 dark:shadow-none flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {(blogs || []).map(blog => (
                    <div key={blog.id} className="group bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-sm hover:shadow-md transition-all duration-300">
                        <div className="h-48 overflow-hidden relative">
                            <img src={blog.thumbnail_url || 'https://via.placeholder.com/400x200'} className="w-full h-full object-cover transition-transform duration-700" alt={blog.title} />
                            <div className="absolute top-4 right-4 flex gap-2">
                                <button onClick={() => handleEdit(blog)} className="p-2 bg-white/90 dark:bg-slate-800/90 backdrop-blur-md rounded-xl text-slate-700 dark:text-white shadow-sm transition-all active:scale-95"><Edit2 className="w-4 h-4" /></button>
                                <button onClick={() => handleDelete(blog.id)} className="p-2 bg-rose-500/90 backdrop-blur-md rounded-xl text-white shadow-sm transition-all active:scale-95"><Trash2 className="w-4 h-4" /></button>
                            </div>
                        </div>
                        <div className="p-6">
                            <h3 className="text-lg font-bold text-slate-900 dark:text-white line-clamp-1 mb-2">{blog.title}</h3>
