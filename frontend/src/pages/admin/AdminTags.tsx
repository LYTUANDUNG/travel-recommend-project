            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1">
                    <div className="bg-white dark:bg-slate-900 p-8 rounded-[2rem] border border-slate-200 dark:border-slate-800 shadow-sm sticky top-8 outline outline-4 outline-slate-50 dark:outline-slate-950">
                        <div className="w-12 h-12 rounded-2xl bg-orange-50 dark:bg-orange-950/30 flex items-center justify-center text-orange-600 dark:text-orange-400 mb-6 font-black text-xl">
                            +
                        </div>
                        ...
                        <form onSubmit={handleCreate} className="space-y-6">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-5 py-3 border border-slate-200 dark:border-slate-700 rounded-2xl bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 outline-none transition-all placeholder:text-slate-400"
                            ...
                            <button type="submit" className="w-full bg-orange-600 hover:bg-orange-700 text-white py-4 rounded-2xl font-black uppercase tracking-widest text-xs transition-all shadow-lg shadow-orange-100 dark:shadow-none active:scale-95 flex items-center justify-center gap-2">
                                        ...
                                        <tr key={t.tag_id} className="group hover:bg-slate-50/80 dark:hover:bg-slate-800/40 transition-all duration-300">
                                            <td className="px-8 py-5">
                                                <div className="flex items-center gap-2 group-hover:translate-x-1 transition-transform">
                                                    <div className="p-2 bg-orange-50 dark:bg-orange-950/40 rounded-xl text-orange-600 dark:text-orange-400">
                                            ...
                                            <td className="px-8 py-5">
                                                <div className="flex items-center gap-3">
                                                    <div className="flex-1 max-w-[100px] h-1.5 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
                                                        <div 
                                                            className="h-full bg-gradient-to-r from-orange-500 to-orange-400 rounded-full shadow-[0_0_8px_rgba(249,115,22,0.5)]" 
                                                            style={{ width: `${(t.weight / 10) * 100}%` }}
                                                        />
                                                    </div>
                                                    <span className="font-black text-orange-600 dark:text-orange-400 text-sm">{t.weight}</span>
                                                </div>
                                            </td>
